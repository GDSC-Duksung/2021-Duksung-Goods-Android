...
class MyPageBuyFragment : Fragment() {
    ...
    override fun onViewCreated(view:View, savedInstanceState:Bundle?){
        ...
        buy_data.apply{
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"1","2021-08-01"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"2","2021-08-02"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"3","2021-08-03"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"4","2021-08-04"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"5","2021-08-05"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"6","2021-08-06"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"7","2021-08-07"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"8","2021-08-08"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"7","2021-08-07"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"8","2021-08-08"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"7","2021-08-07"))
            add(BuyData("덕성여대 버건디 수건", R.drawable.towel,"8","2021-08-08"))
