...
class HomeFragment : Fragment() {
    ...
    private val bannerAdapter = activity?.let { HomeBannerAdapter(bannerList, it) }
    ...
    //section 1, 2, 3
    private val sectionItemList1 = arrayListOf<ModelImageText>()
    private val sectionAdapter1 = activity?.let{ HomeSectionAdapter(sectionItemList1, it) }
    private val sectionItemList2 = arrayListOf<ModelImageText>()
    private val sectionAdapter2 = activity?.let{ HomeSectionAdapter(sectionItemList2, it) }
    private val sectionItemList3 = arrayListOf<ModelImageText>()
    private val sectionAdapter3 = activity?.let{ HomeSectionAdapter(sectionItemList3, it) }
